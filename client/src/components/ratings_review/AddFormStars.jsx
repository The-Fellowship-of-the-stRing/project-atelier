...
const AddFormStars = ({rating, updateRating}) => {
  ...
  return (
    <div id="stars-main-container">
      <div id="stars-outline-container">
       {
        starLength.map((star, index) => {
          return (
            <div key={index} id="star-outline" onClick={() => updateRating(index + 1)} style={{cursor: "pointer"}}>
      ...
      <div id="stars-filled-container" style={{width: `${rating * 20}%`}}>
      {
        starLength.map((star, index) => {
          return (
            <div key={index} id="star-fill" onClick={() => updateRating(index + 1)} style={{cursor: "pointer"}}>
