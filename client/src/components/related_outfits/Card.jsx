...
const Card = ( {cardDetails, itemName, className, action, addProduct, deleteProduct, itemFeatures, updateMainProduct} ) => {
  ...
  // useEffect(() => {
  //   // MOVE THIS TO RELATED SO THAT EVERY CARD IS LOADED INITIALL
